from system_object import Star, Planet
    ...
    **space_objects** — список объектов планет и звёзд
    ...
    with open(output_filename, 'w') as out_file:
        for obj in space_objects:
            obj_params_string = str(obj.type) + ' ' + str(obj.R) + ' ' + str(obj.color) + ' ' + str(obj.m) + ' ' + str(obj.x) + ' ' + str(obj.y) + ' ' + str(obj.Vx) + ' ' + str(obj.Vy)
            #n = out_file.write(obj_params_string, '\n')
            out_file.flush()
        # out_file.close()
